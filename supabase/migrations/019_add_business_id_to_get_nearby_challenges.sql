-- ============================================================================
-- Add business_id to get_nearby_challenges RPC Function
-- Updates the function to return business_id so business challenges can be identified
-- ============================================================================

-- Drop the existing function first (required when changing return type)
-- Try different type variations to ensure we drop the right one
DO $$
BEGIN
...
-- Recreate the get_nearby_challenges function to include business_id
...
BEGIN
  ...
  SELECT 
    ...
    c.business_id  -- Add business_id to the return
  FROM challenges c
